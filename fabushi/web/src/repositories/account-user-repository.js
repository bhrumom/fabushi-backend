...
export class AccountUserRepository {
  ...
  async renameUsernameReferences({ userId, oldUsername, newUsername }) {
    ...
    const updates = [
      ...
      ['UPDATE meditation_records SET username = ?, user_id = ? WHERE user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE meditation_records SET username = ? WHERE username = ?', newUsername, oldUsername],
      ['UPDATE meditation_goals SET username = ?, user_id = ? WHERE user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE meditation_goals SET username = ? WHERE username = ?', newUsername, oldUsername],
      ['UPDATE meditation_settings SET username = ?, user_id = ? WHERE user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE meditation_settings SET username = ? WHERE username = ?', newUsername, oldUsername],
      ['UPDATE meditation_groups SET owner_username = ?, owner_user_id = ? WHERE owner_user_id = ? OR owner_username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE meditation_groups SET owner_username = ? WHERE owner_username = ?', newUsername, oldUsername],
      ['UPDATE meditation_group_members SET username = ?, user_id = ? WHERE user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE meditation_group_members SET username = ? WHERE username = ?', newUsername, oldUsername],
      ['UPDATE user_follows SET follower_username = ?, follower_user_id = ? WHERE follower_user_id = ? OR follower_username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE user_follows SET follower_username = ? WHERE follower_username = ?', newUsername, oldUsername],
      ['UPDATE user_follows SET following_username = ?, following_user_id = ? WHERE following_user_id = ? OR following_username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE user_follows SET following_username = ? WHERE following_username = ?', newUsername, oldUsername],
      ['UPDATE user_practice_privacy SET username = ?, user_id = ? WHERE user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ...
      ['UPDATE comments SET username = ?, account_user_id = ? WHERE account_user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ...
      ['UPDATE content_likes SET username = ?, account_user_id = ? WHERE account_user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
      ['UPDATE content_likes SET username = ? WHERE username = ?', newUsername, oldUsername],
      ['UPDATE content_favorites SET username = ?, user_id = ? WHERE user_id = ? OR username = ?', newUsername, userId, userId, oldUsername],
